...
from wtforms.validators import DataRequired, Email, Lenght
...
class LoginForm(FlaskForm):
    ...
    password = PasswordField(label='Password', validators=[DataRequired(), Lenght(min=8)])    # 비밀번호 - string 형식, 유효성 검사
