...
class QuizBrain:                                    # QuizBrain 이라는 클래스 생성 
    ...
    def next_question(self):
        ...
        user_answer = input(f"Q.{self.question_number}: {current_question.text} (True/False): ")      # 입력할 정답 호출 
        self.check_answer(user_answer, current_question.answer)                                       # 입력할 정답의 값들을 check_answer로 전달 
